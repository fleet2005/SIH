...
def grid_to_longitude(grid_x):
    ...
    # Modify rounding for longitude to nearest multiple of 0.5 starting from 0.125
    longitude = round((longitude - 0.125) / 0.5) * 0.5 + 0.125
...
while running:
    ...
    print("Longitude = ", grid_to_longitude(102))
